...
- Tickets has been moved to the web component repository https://github.com/vaadin/vaadin-checkbox/issues
...
- `mvn  -pl vaadin-checkbox-flow-demo -Pwar install jetty:run`
